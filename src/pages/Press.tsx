                ...
                {[
                  {
                    ...
                    date: "December 2024",
                    content: "Our community marketplace continues to grow as more users discover the benefits of sharing unused subscriptions."
                  },
                  {
                    title: "Series A Funding Round Completed",
                    date: "November 2024",
                    content: "SplitClub raises $5M to expand platform features and community reach."
                  }
                ].map((news, index) => (
                  <motion.div 
                    key={index}
