...
import { ArrowLeft, ArrowRight, Upload, Gift, DollarSign } from 'lucide-react';
...
export const UploadRewardDetails = ({
  ...
  const canProceed = formData.title && formData.source && formData.redemptionType;
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center space-x-4 p-4 border rounded-lg">
            <div className="flex items-center space-x-2">
              ...
              <span className={!formData.isForSale ? 'font-medium text-green-600' : 'text-muted-foreground'}>
                Gift (Free)
              </span>
            </div>
            <Switch
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className={formData.isForSale ? 'font-medium text-blue-600' : 'text-muted-foreground'}>
                Sell
              </span>
            </div>
          </div>
        ...
        <div>
          <Label htmlFor="redemptionType">How to Share Access *</Label>
