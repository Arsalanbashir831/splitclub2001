...
export const Careers = () => {
  const openings = [
    {
      ...
      location: "Remote",
      type: "Full-time",
      description: "Join our frontend team to build beautiful, accessible user interfaces that help people save money and reduce waste."
    },
    {
      ...
      type: "Full-time",
      description: "Help build and nurture our growing community of users who are passionate about sustainable consumption."
    },
    {
      ...
      location: "Remote",
      type: "Full-time",
      description: "Design intuitive experiences that make sharing deals and subscriptions delightful and easy for our users."
    },
    {
      title: "Data Analyst",
      ...
      type: "Full-time",
      description: "Help us understand user behavior and optimize our platform using data-driven insights and analytics."
    }
  ];
  ...
  const benefits = [
    ...
    },
    {
      icon: Users,
      title: "Team Culture",
      description: "Collaborative environment with regular team retreats and social events"
    },
    {
      icon: Zap,
      title: "Growth",
    ...
    >
      ...
      >
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          >
            Help us build the future of sustainable consumption. Join a mission-driven team that's making a real impact on how people save money and reduce waste.
          </motion.p>
        </div>
      </motion.section>
