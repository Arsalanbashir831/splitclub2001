			...
			<CardContent className="p-0 h-full flex flex-col">
				...
				<div className="relative h-48 bg-gradient-to-br from-primary to-purple-600 overflow-hidden">
					...
					<div className="absolute top-3 right-3">
						<Badge
							variant={deal.status === "active" ? "default" : "destructive"}>
							{deal.status}
						</Badge>
					</div>
				</div>
					...
					<div className="flex-1">
						...
						<div className="space-y-3 mb-4">
							...
							<div className="flex items-center text-sm text-muted-foreground">
								...
								<span>
									{deal.availableSlots} of {deal.totalSlots} slots available
								</span>
							</div>
						...
						<div className="flex items-center space-x-8 flex-1">
							...
							<div className="flex-1">
								...
								<div className="flex items-center gap-3">
									...
									<Badge
										variant="secondary"
										className="bg-emerald-500/20 text-emerald-100 border-emerald-300/30 backdrop-blur-sm px-4 py-2 text-sm font-medium">
										...
										<Card className="border-0 shadow-xl bg-card">
											<CardContent className="text-center py-16">
												...
												<p className="text-muted-foreground mb-8 max-w-md mx-auto">
													Start sharing your unused subscriptions, memberships,
													and rewards to help others save money while reducing
													waste.
												</p>
												<Button
										...
										<Card className="border-0 shadow-xl bg-card">
											<CardContent className="text-center py-16">
												...
												<p className="text-muted-foreground mb-8 max-w-md mx-auto">
													...
													saving money on subscriptions and memberships.
												</p>
												<Button
													onClick={() => navigate("/deals")}
													size="lg"
													className="bg-gradient-to-r from-green-500 to-primary hover:from-green-600 hover:to-primary/80">
									...
									<div className="col-span-full">
										<Card className="border-0 shadow-xl bg-card">
											<CardContent className="text-center py-16">
												...
												<p className="text-muted-foreground mb-8 max-w-md mx-auto">
													Mark deals as favorites to easily find them later and
													get notified about similar offers.
												</p>
												<Button
													onClick={() => navigate("/deals")}
													size="lg"
				...
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							...
							undone. All associated images, voucher files, and claims will be
							permanently removed.
						</AlertDialogDescription>
					</AlertDialogHeader>
					<AlertDialogFooter>
