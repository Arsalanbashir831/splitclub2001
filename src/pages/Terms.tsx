					...
					<Card>
						...
						<CardContent>
							<p className="text-muted-foreground">
								By accessing and using SplitClub, you accept and agree to be
					...
					<Card>
						...
						<CardContent>
							<p className="text-muted-foreground">
								...
								SplitClub per device for personal, non-commercial transitory
								viewing only.
							</p>
						</CardContent>
					</Card>
					...
					<Card>
						...
						<CardContent>
							<p className="text-muted-foreground">
								...
								contact us at legal@splitclub.com
							</p>
						</CardContent>
					</Card>
				</div>
