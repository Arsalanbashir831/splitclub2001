  ...
  const jobOpenings = [
    {
      ...
      description: 'Join our engineering team to build beautiful and performant user interfaces for our community marketplace.'
    },
    {
      ...
      type: 'Full-time', 
      department: 'Product',
      description: 'Drive product strategy and execution to enhance user experience and grow our community.'
    },
    {
      ...
      description: 'Build and nurture our community, creating engaging experiences for our users.'
    },
    {
      ...
      description: 'Support our marketing initiatives and help spread the word about SplitClub.'
    }
  ];
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <p className="text-muted-foreground leading-relaxed mb-4">
              At SplitClub, you'll be part of a mission-driven team that's creating real impact. We're building something that matters - a platform that reduces waste, saves money, and brings communities together. Join us if you're passionate about sustainability, technology, and creating positive change.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  We're scaling rapidly and every team member has the opportunity to make a significant impact.
                </p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  We support flexible work arrangements and have team members across different time zones.
                </p>
              </div>
              <div>
                <h4 className="font-semibold mb-2">🎯 Results-Oriented</h4>
                <p className="text-sm text-muted-foreground">
                  We focus on outcomes over hours, giving you the autonomy to do your best work.
                </p>
              </div>
            </div>
          </CardContent>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Brief call with our talent team to learn about you and the role</p>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Role-specific evaluation to assess your skills and fit</p>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Meet with team members and leadership to discuss the opportunity</p>
                </div>
              </div>
            </div>
          </CardContent>
