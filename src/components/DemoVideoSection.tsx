          ...
          {[
            {
              ...
              description: "Upload unused subscriptions, vouchers, and memberships"
            },
            {
              step: "2", 
              title: "Browse & Claim",
              description: "Find great deals from the community and claim your favorites"
            },
            {
              step: "3",
              title: "Save & Sustain", 
              description: "Reduce waste while saving money for everyone in the community"
            }
          ].map((item, index) => (
            <motion.div 
              key={index}
